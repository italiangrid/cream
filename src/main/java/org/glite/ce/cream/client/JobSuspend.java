...
public class JobSuspend extends JobCommand {

    public JobSuspend(String[] args, List<String> options) throws RuntimeException {
        super(args, options);
    }

    protected void execute() {
        try {
            printResult(getCREAMStub().jobSuspend(getJobIdList(), getStatus(), getFromDate(), getToDate(), getDelegationId(), getLeaseId()), "job being suspended");
