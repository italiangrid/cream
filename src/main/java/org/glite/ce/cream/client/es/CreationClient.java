...
public class CreationClient extends ActivityCommand {
    ...
    public static void main(String[] args) {
        ...
        new CreationClient(args, options);
    }

    public CreationClient(String[] args, List<String> options) throws RuntimeException {
        super(args, options);
    }
        ...
        try {
            ...
            for (int i = 0; i < activityResponse.length; i++) {
                if (activityResponse[i].isActivityCreationResponseSequence_type1Specified()) {
                    ...
                    System.out.println("activityManagerURI = " + checkValue(sequence.getActivityManagerURI()));
