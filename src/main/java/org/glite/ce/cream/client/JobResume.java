...
public class JobResume extends JobCommand {

    public JobResume(String[] args, List<String> options) throws RuntimeException {
        super(args, options);
    }

    public void execute() {
        try {
            printResult(getCREAMStub().jobResume(getJobIdList(), getStatus(), getFromDate(), getToDate(), getDelegationId(), getLeaseId()), "job being resumed");
