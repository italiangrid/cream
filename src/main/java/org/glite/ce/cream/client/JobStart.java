...
public class JobStart extends JobCommand {

    public JobStart(String[] args, List<String> options) throws RuntimeException {
        super(args, options);
    }

    public void execute() {
        try {
            printResult(getCREAMStub().jobStart(getJobIdList(), getStatus(), getFromDate(), getToDate(), getDelegationId(), getLeaseId()), "job being started");
