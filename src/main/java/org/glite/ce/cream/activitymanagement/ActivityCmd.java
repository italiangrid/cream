...
public class ActivityCmd extends Command {
    ...
    public static enum ActivityCommandField { ACTIVITY_CHECK, ACTIVITY_CHECK_ON, ACTIVITY_CHECK_OFF, ACTIVITY_DESCRIPTION, ACTIVITY_GLUE2_ATTRIBUTE_LIST,
        ACTIVITY_ID, ACTIVITY_ID_LIST, ACTIVITY_STATUS, ACTIVITY_STATUS_ATTRIBUTE_LIST, ACTIVITY_STATUS_DESCRIPTION, ACTIVITY_STATUS_LIST,
        ACTIVITY_STATUS_TIMESTAMP, DELEGATION_SANDBOX_FILE_NAME, DELEGATION_SANDBOX_PATH, FROM_DATE, IS_TRUNCATED, LIMIT, LOCAL_USER, LOCAL_USER_GROUP,
        NOTIFY_MESSAGE, SERVICE_URL, SERVICE_GSI_URL, STAGE_IN_URI, STAGE_OUT_URI, TO_DATE, USER_DN, USER_FQAN, VIRTUAL_ORGANISATION 
    }
