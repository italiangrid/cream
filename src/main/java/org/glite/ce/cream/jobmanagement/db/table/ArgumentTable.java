...
public class ArgumentTable implements ArgumentTableInterface {
    ...
    private final static Logger logger = Logger.getLogger(ArgumentTable.class);

    public ArgumentTable() throws SQLException {
        logger.debug("Call ArgumentTable constructor");
    }
    ...
    public int executeInsert(String jobId, List<String> arguments, Connection connection) throws SQLException {
        ...
        // logger.debug("insertQuery (ArgumentTable)= " + insertQuery);
        ...
        try {
            ...
            for (String argument : arguments) {
                insertPreparedStatement = fillInsertPreparedStatement(jobId, argument, insertPreparedStatement);
    ...
    public List<String> executeSelect(String jobId, Connection connection) throws SQLException {
        ...
        // logger.debug("selectQuery (ArgumentTable)= " + selectQuery);
        ...
        try {
            ...
            while (resultSet.next()) {
                argumentList.add(resultSet.getString(ArgumentTable.VALUE_FIELD));
            }
        } catch (SQLException sqle) {
            throw sqle;
        } finally {
    ...
    public int executeDelete(String jobId, Connection connection) throws SQLException {
        ...
        // logger.debug("deleteQuery (ArgumentTable)= " + deleteQuery);
    ...
    private PreparedStatement fillInsertPreparedStatement(String jobId, String argument, PreparedStatement insertPreparedStatement) throws SQLException {
        insertPreparedStatement.setString(1, argument);
    ...
    private static String getInsertQuery() {
        ...
        insertQuery.append(ArgumentTable.NAME_TABLE);
        insertQuery.append(" ( ");
