...
public final class JobInfoCmd extends JobCmd {

    public JobInfoCmd() {
        super(JobCommandConstant.JOB_INFO);
        setAsynchronous(false);
    }

    public JobEnumeration getJobEnumeration() {
        return (JobEnumeration)getResult().getParameter("JOB_ENUM");
    }
}
